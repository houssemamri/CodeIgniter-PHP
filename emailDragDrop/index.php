...
<html lang="en" style="overflow: hidden;">
    <head>
        ...
        <script src="//cdn.jsdelivr.net/npm/toastr@2.1.4/build/toastr.min.js"></script>
        ...
        <div class="navbar navbar-inverse navbar-fixed-top navbar-layoutit">
            <div style="float: right;">
                <div class="form-group">
                    <input class="form-control" aria-label="Large" aria-describedby="inputGroup-sizing-sm" type="text" name="name" id="name" placeholder="Enter template name">
                </div>
                <ul class="nav" id="menu-layoutit">
                    <li>
                        <div class="btn-group">
                            <button type="button" class="btn btn btn-danger" id = "cancel"><i class="glyphicon glyphicon-remove"></i> Close</button>
                        </div>
...
<!--                    <div class="modal-header">-->
                        <input id="httphref" type="hidden" name="href" value="https://" class="form-control" />
<!--                    </div>-->
