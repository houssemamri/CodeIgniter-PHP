	...
	public function fieldUpdate(){
		...
		if(!isset($_POST['fieldSave']) || 
				!array_key_exists($_POST['fieldSave'],$LETHE_SUBSCRIBE_SAVE_FIELDS) && 
					($_POST['fieldSave']!='recaptcha' && $_POST['fieldSave']!='addremove'  && $_POST['fieldSave']!='subscriber_mail'  && $_POST['fieldSave']!='grpchoicer' && $_POST['fieldSave']!='subscriber_tag')){$errText.='* '. subscribers_incorrect_field_save_area .'<br>';}
