...
<link href="css/rthunder.css" rel="stylesheet">	
    <!-- Styles -->
...
<div id="lethe">
	...
	<div id="lethe-nav" class="container-fluid">
		<!-- NAVIGATION -->
		<?php include_once('inc/inc_nav.php');?>
		<!-- NAVIGATION -->
	</div>
	
	<div id="lethe-main" class="container-fluid">
		<!-- CONTENT -->
	...
	<div id="lethe-footer" class="container-fluid">
		<!-- FOOTER -->
...
<script src="Scripts/rthunder.js"></script>
<script>
parent.resizeIframe(parent.document.getElementById("myLethe"));
