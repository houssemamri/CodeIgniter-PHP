...
$LETHE_EXP_IMP_MIMES = array('text/plain','text/csv','application/csv','application/x-csv','application/vnd.ms-excel','text/x-csv','text/comma-separated-values','text/x-comma-separated-values','text/tab-separated-values');
...
$LETHE_BOUNCE_ACTIONS = array(letheglobal_remove,letheglobal_remove_and_add_to_blacklist,letheglobal_move_to_unsubscribe_group,'No Action');
