				...
				<div class="row">
					<div class="col-md-4">
						<div class="alert alert-info">
							<strong>IMPORTANT:</strong> Auto table creation disabled on v2.1, please import table structure via phpMyAdmin before installation. Some hosting service sql_mode configurations does not allow to create tables as our script-based queries.
						</div>
