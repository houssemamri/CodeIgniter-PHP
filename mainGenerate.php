                    ...
                    <?php if (isset($_GET['article'])) {
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-12">
                                ...
                                if ($_GET['article'] == 1) {
                                    ?>
                                    <h2 style="font-size: 20px;"><?php echo $ans1; ?></h2><br />
                                    <ul class="list-unstyled">
                                    ...
                                    ?>
                                    <h2 style="font-size: 20px"><?php echo $ans2; ?></h2><br />
                                    <ul class="list-unstyled">
                                    ...
                                    ?>
                                    <h2 style="font-size: 20px;"><?php echo $ans3; ?></h2><br />
                                    <ul class="list-unstyled">
                        ...
                        <div class="row">
                            <div class="col-12 col-lg-12">
                                <h2 style="font-size: 20px;"><?php echo $generateHeader; ?></h2><br />
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 align-self-center text-center">
                        <div class="row">
                            ...
                            <div class="col-12 col-lg-12">
                            <h2 style="font-size: 20px;"><?php echo $mailsendheader; ?></h2>
                                <br /><br />
                                <?php
                                $lang = $_GET['lang'];
                                $num = $_GET['article'];
