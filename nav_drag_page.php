      ...
      <ul class="topbar-nav nav">
        ...
        <li class="nav-item"><a class="nav-link" href="#"><?php echo $database;?><i class="fa fa-caret-down"></i></a>
          <div class="nav-submenu align-right">
            <a class="nav-link" href="../upload.php?status=true&type=Hotel&lang=fr&article=1"><?php echo $add;?></a>
            <a class="nav-link" href="../update.php?status=true&type=Hotel&lang=fr&article=1"><?php echo $update;?></a>
          </div>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">
            ...
            $row=$result->fetch_assoc();*/?>
              <img src="../img/logo1.png" alt="" height="30" width="30" />
            <?php
          ...
          <div class="nav-submenu align-right">
            ...
            <a class="nav-link" href="../manageVideos.php?id=<?php echo $_SESSION['user_id'];?>">Manage Videos</a>
            ...
            <a class="nav-link" href="../newsletter/admin/pg.login_external.php?logout=1"><?php echo $logout;?></a>
          </div>
        </li>
        <li class="nav-item"><a class="nav-link" href="#"><?php echo $changelang;?> <i class="fa fa-caret-down"></i></a>
          <div class="nav-submenu align-right">
              <a class="nav-link" href="../language.php?lang=fr"><img class="language" src="../img/french.png" /><?php echo $lang1;?></a>
              <a class="nav-link" href="../language.php?lang=en"><img class="language" src="../img/english.png" /> <?php echo $lang2;?></a>
              <a class="nav-link" href="../language.php?lang=spa"><img class="language" src="../img/spanish.png" /> <?php echo $lang3;?></a>
          </div>
        </li>
      </ul>
    </div>
