...
class Tickets extends CI_MODEL {
     ...
     * @param string $attachment contains the ticket's attachment
     * 
     * @return boolean true or false
     */
    public function save_ticket( $user_id, $subject, $body, $attachment = NULL ) {
        
        // Set data
        $data = ['user_id' => $user_id, 'subject' => $subject, 'body' => $body, 'attachment' => $attachment, 'status' => 1, 'created' => time()];
     ...
     * @return boolean true or false
     */
    public function save_reply( $user_id, $ticket_id, $body, $attachment = NULL ) {
        ...
        $data = ['user_id' => $user_id, 'ticket_id' => $ticket_id, 'body' => $body, 'attachment' => $attachment, 'created' => time()];
     ...
     */
    public function get_all_tickets( $user_id, $start, $limit ) {
    ...
    /**
     * The public method ticket_status changes ticket's status
     *
     * @param integer $ticket_id contains the ticket_id
     * @param integer $status contains the new ticket status
     * 
     * @return boolean true or false
     */
     ...
     */
    public function get_ticket( $user_id, $ticket_id ) {
