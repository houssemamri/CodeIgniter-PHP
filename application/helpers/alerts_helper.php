    ...
    function display_mess($mess = NULL, $arg = NULL) {
        ...
        switch ($mess) {
            ...
            case '15':
                ...
                break;
            case '16':
                echo json_encode('<p class="merror">'.$CI->lang->line('mm19').'</p>');
                break;
            case '17':
            ...
            case '43':
                ...
                break;
            case '44':
                echo $CI->lang->line('mm43');
                break;
            case '45':
                echo $CI->lang->line('mm3');
                break;
            case '47':
                echo $CI->lang->line('mm44');
                break;
            case '48':
                echo json_encode('<p class="merror">'.$CI->lang->line('mm45').'</p>');
                break;
            case '50':
                return '<p class="error">'.$CI->lang->line('mm46').'</p>';
                break;
            case '51':
                return '<p class="success">'.$CI->lang->line('mm47').'</p>';
                break;
            case '52':
            ...
            case '56':
                ...
                break;
            case '57':
                echo json_encode('<p class="error">'.$CI->lang->line('mm53').'</p>');
                break;
            case '58':
            ...
            case '64':
                ...
                break;
            case '65':
                return '<p>'.$CI->lang->line('mm61').'</p>';
                break;
            case '66':
                echo json_encode($CI->lang->line('mm44'));
                break;
            case '67':
                echo json_encode('<p class="success">'.$CI->lang->line('mm2').'</p>');
                break;
            case '68':
                echo json_encode('<p class="error">'.$CI->lang->line('mm1').'</p>');
                break;
            case '69':
                return '<p>'.$CI->lang->line('mm62').'</p>';
                break;
            case '70':
                return '<p>'.$CI->lang->line('mm63').'</p>';
                break;
            case '71':
                return '<p>'.$CI->lang->line('mm64').'</p>';
                break;
            case '72':
                return '<p>'.$CI->lang->line('mm65').'</p>';
                break;
            case '73':
                return '<p>'.$CI->lang->line('mm66').'</p>';
                break;
            case '74':
                return '<p>'.$CI->lang->line('mm67').'</p>';
                break;
            case '75':
                return '<p>'.$CI->lang->line('mm68').'</p>';
                break;
            case '76':
            ...
            case '85':
                ...
                break;
            case '86':
                return $CI->lang->line('mm80');
                break;
            case '87':
                return $CI->lang->line('mm81');
                break;
            case '88':
                return $CI->lang->line('mm82');
                break;
            case '89':
                return $CI->lang->line('mm83');
                break;
            case '90':
            ...
            case '99':
                ...
                break;
            case '100':
                return '<p>'.$CI->lang->line('mm94').'</p>';
                break;
            case '101':
                return '<p>'.$CI->lang->line('mm95').'</p>';
                break;
            case '101':
                return '<p class="merror block">'.$CI->lang->line('mm96').'</p>';
                break;
            case '102':
            ...
            case '123':
                ...
                break;
            case '124':
                return '<p>'.$CI->lang->line('mm181').'</p>';
                break;
            case '125':
                return '<p>'.$CI->lang->line('mm182').'</p>';
                break;
            case '126':
                return '<p>'.$CI->lang->line('mm183').'</p>';
                break;
            case '127':
                return '<p>'.$CI->lang->line('mm184').'</p>';
                break;
            case '128':
                return '<p>'.$CI->lang->line('mm185').'</p>';
                break;
            case '129':
                return '<p>'.$CI->lang->line('mm186').'</p>';
                break;
            case '130':
            ...
            case '131':
                ...
                break;
            case '132':
                return $CI->lang->line('mm197');
                break;
            case '133':
                return $CI->lang->line('mm198');
                break;
            case '134':
