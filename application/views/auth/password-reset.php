...
<html lang="en">
    <head>
        <title><?= $this->lang->line('m30'); ?></title>
    ...
    <body<?php get_browser_class(); if ($img) { echo ' style="background-image:url(' . $img . ')"'; } ?>>
        ...
        <div class="container">
            <div class="col-lg-3 col-sm-4 col-xs-12 logi">
                <?= form_open('new-password', ['class' => 'reset']) ?>
                <div class="row logo">
                ...
                <div class="row welcome">
                    <div class="col-lg-12 text-center">
                        <h3><?= $this->lang->line('m26'); ?></h3>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <input type="email" class="form-control input email" name="email" placeholder="<?= $this->lang->line('m25'); ?>" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <button type="submit" class="btn btn-all btn-recover"><?= $this->lang->line('m24'); ?></button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <p class="signup"><span><?= $this->lang->line('m28'); ?></span> <a href="<?= site_url('/') ?>"><?= $this->lang->line('m29'); ?></a></p>
                    </div>
                </div>     
                <?= form_close() ?>                                                   
            </div>
