 ...
 <?php
  ...
  <body class="mh-fullscreen bg-img center-vh p-20" style="background-image: url(<?php  echo base_url(); ?>img/Login-page.jpg);">
    ...
    <div class="card card-shadowed p-50 w-400 mb-0" style="background-color:rgba(255,255,255,0.6);max-width: 100%">
	  ...
	  <input type="hidden" id="logourl" name="logourl" value="<?= base_url(); ?>"  />
<!-- <div class="row logo">
      ...
      <?= form_open('login', ['class' => 'signin']) ?>
        ...
        <div class="form-group">
          <input type="text" class="form-control input username" name="email" placeholder="<?= $this->lang->line('m15'); ?>" required>
        </div>
        ...
        <div class="form-group">
         ...
         <div class="form-group">
                    <div class="col-lg-12">
                        <p class="remember"><span><input type="checkbox" id="remember"></span> <span><?php echo $rememberMe; ?></span></p>
                    </div>
                </div>
        ...
        <input type="text" id="setLang_id" hidden value="<?php echo $lang;?>" name="setLang" />
        <br />
        <ul class="list-inline text-center">
          <li class="list-inline-item"><a href="https://review-thunder.com/language.php?lang=fr"><img class="language" src="<?= base_url(); ?>img/french.png" /></a></li>
          <li class="list-inline-item"><a href="https://review-thunder.com/language.php?lang=en"><img class="language" src="<?= base_url(); ?>img/english.png" /></a></li>
          <li class="list-inline-item"><a href="https://review-thunder.com/language.php?lang=spa"><img class="language" src="<?= base_url(); ?>img/spanish.png" /></a></li>
        </ul>
      <?= form_close() ?> 
