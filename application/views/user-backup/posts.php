<section data-cont="<?= $selected_accounts ?>" data-up="<?= (get_option('upload_limit'))?get_option('upload_limit'):'6'; ?>" data-act="<?= (get_option('posts_planner_limit'))?get_option('posts_planner_limit'):'1'; ?>">
    ...
    <div class="container-fluid posts">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 pull-left">
            <div class="col-lg-12 emojies clean">
                <div class="panel">
                    <div class="panel-heading">
                        <ul class="nav nav-tabs">
                           <li class="active"><a href="#emojies-peoples" data-toggle="tab" class="emoji-cat">😎‍</a></li>
                           <li><a href="#emojies-animals" data-toggle="tab" class="emoji-cat">🙉</a></li>
                           <li><a href="#emojies-food" data-toggle="tab" class="emoji-cat">🍔</a></li>
                           <li><a href="#emojies-sport" data-toggle="tab" class="emoji-cat">🏀</a></li>
                           <li><a href="#emojies-travel" data-toggle="tab" class="emoji-cat">🚢</a></li>
                           <li><a href="#emojies-signs" data-toggle="tab" class="emoji-cat">🔱</a></li>
                           <li><a href="#emojies-objects" data-toggle="tab" class="emoji-cat">📻</a></li>
                        </ul>
                    </div>
