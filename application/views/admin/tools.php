                            ...
                            <div class="widget-box">
                                <div class="widget-header">
                                    <div class="widget-toolbar">
                                        <ul class="nav ">
                                            <li class="active nav-item" style="background-color: none !important;"> <a style="background-color: none !important;" class="nav-link" data-toggle="tab" href="#all" aria-expanded="true"><?= $this->lang->line('ma88'); ?></a> </li>
                                            <li class=" nav-item" style="background-color: none !important;"> <a  class="nav-link" data-toggle="tab" href="#settings" aria-expanded="false"><?= $this->lang->line('ma7'); ?></a> </li>
                                        </ul>
                                    </div>
                                </div>
