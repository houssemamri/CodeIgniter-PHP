...
class Google_plus implements Autopost {
    ...
    public function preview($args) {
        ...
        return (object) [
                    'name' => 'google_plus',
                    'icon' => '<button type="button" class="btn btn-network-y"><i class="fa fa-google-plus"></i><span data-network="google_plus"><i class="fa fa-times"></i></span></button>',
                    'head' => '<li class="google_plus"><a href="#google_plus" data-toggle="tab"><i class="fa fa-google-plus"></i></li>',
                    'content' => '<div class="tab-pane" id="google_plus">
