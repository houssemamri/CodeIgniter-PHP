...
class Vk implements Autopost {
    ...
    public function __construct() {
        ...
        $this->redirect_uri = 'https://oauth.vk.com/authorize?client_id='.$this->client_id. '&scope=wall,offline,photos,friends&redirect_uri=https://oauth.vk.com/blank.html&display=page&v=5.73&response_type=code';
    ...
    public function connect() {
        ...
        if ( $this->params ) {
            ...
            // Get redirect url
            $loginUrl = 'https://oauth.vk.com/authorize?' . urldecode(http_build_query($this->params));
