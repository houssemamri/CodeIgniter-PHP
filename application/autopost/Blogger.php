...
class Blogger implements Autopost {
    ...
    public function __construct() {
        ...
        $appName = get_option('blogger_google_application_name');
        ...
        // Blogger Callback
        $scriptUri = base_url() . 'user/callback/blogger';
                    ...
                    if ( @$udecode->sub ) {
                        ...
                        if ( $blogs ) {
                            ...
                            if (@$getBlogs->blogUserInfos[0]->blog->id) {
                                ...
                                // Return message
                                $this->CI->session->set_flashdata('deleted', display_mess(83));
            ...
            if ($con[0]->secret) {
                ...
                try {
                    ...
                    if ( $args ['title'] ) {
                        ...
                        // Set body
                        $post->setContent( $args['post'] );
                        
                    } else {
                        
                        // Set title
                        $post->setTitle( $args['post'] );
    ...
    public function get_info() {
        ...
        return (object) ['color' => '#fb8f3d', 'icon' => '<i class="fa fa-bold" style="color:#ffffff"></i>', 'rss' => true, 'api' => ['client_id', 'client_secret', 'api_key', 'google_application_name'], 'types' => 'text, links', 'categories' => true];
    ...
    public function preview($url = null) {
        ...
        return (object) [
                    'name' => 'blogger',
                    'icon' => '<button type="button" class="btn btn-network-b"><img src="/assets/img/blogger.png"><span data-network="blogger"><i class="fa fa-times"></i></span></button>',
                    'head' => '<li class="blogger"><a href="#blogger" data-toggle="tab"><img src="/assets/img/blogger.png"></a></li>',
                    'content' => '<div class="tab-pane" id="blogger">
					                  <div class="blogger forall"><div>
