    ...
    public function page($args) {
        ...
        if (get_option('rss_feeds') == 1) {
            $options .= '<div class="row">
                            <div id="general" class="tab-pane active">
                                <div class="setrow">
                                    <div class="col-lg-10 col-sm-9 col-xs-9">' . $CI->lang->line('mt22') . '</div>
        ...
        if(get_option('email_marketing') && (plan_feature('sent_emails') > 0)){
            $options .= '<div class="row">
                            <div id="general" class="tab-pane active">
                                <div class="setrow">
                                    <div class="col-lg-10 col-sm-9 col-xs-9">' . $CI->lang->line('mt23') . '</div>
                                    <div class="col-lg-2 col-sm-3 col-xs-3 text-right">
                                        <div class="enablus pull-right">
            ...
            <div class="row">
                    ...
                    <div class="col-lg-12 resent">
                        <div class="row">
                            <div class="panel-heading">
                                '.$CI->lang->line('mt20').'<ul class="nav navbar-nav navbar-right order-by-posts"><li class="dropdown"><a href="#" class="dropdown-toggle display-by" data-toggle="dropdown" role="button" aria-expanded="false">'.$CI->lang->line('mt25').' <span class="caret"></span></a><ul class="dropdown-menu" role="menu"><li><a href="#" data-toggle="modal" data-target="#new-group" class="order-planned-posts" data-type="1">'.$CI->lang->line('mt26').'</a></li><li><a href="#" class="show-planner-options">'.$CI->lang->line('mt3').'</a></li></ul></li></ul>
                            </div>
                        </div>
                        <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 mess-planner" data-act="'.$act.'">
                    ...
                    <div class="col-lg-12 resent show-preview netshow-list">
                        <div class="row">
                            <div class="panel-heading">
                            <i class="fa fa-language"></i> '.$CI->lang->line('mt28').' <div class="btn-group pull-right"><button type="button" data-toggle="modal" data-target="#new-contu" data-type="main" class="btn btn-default new-contu">'.$CI->lang->line('mt29').'</button></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 post-plans">
                    ...
                    <div class="col-lg-12 resent optionss-list">
                        ...
                        <div class="row">
                            <div id="general" class="tab-pane active">
                                <div class="setrow">
                                    <div class="col-lg-10 col-sm-9 col-xs-9">'.$CI->lang->line('mt21').'</div>
                                    <div class="col-lg-2 col-sm-3 col-xs-3 text-right">
                                        <div class="enablus pull-right">
                        ...
                        <div class="row">
                            <div id="general" class="tab-pane active">
                                <div class="setrow">
                                    <div class="col-lg-10 col-sm-9 col-xs-9">' . $CI->lang->line('mt24') . '</div>
                                    <div class="col-lg-2 col-sm-3 col-xs-3 text-right">
                                        <div class="enablus pull-right">
                                            <input id="display_preview_box" name="display_preview_box" class="setopt" type="checkbox"' . $prev . '>
                                            <label for="display_preview_box"></label>
                                        </div>
                                    </div>
                                </div>
                            </div>
