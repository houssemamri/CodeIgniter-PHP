...
class Visam implements Boots {
    ...
    public function content() {
        ...
        if ( $this->token == '' ) {
            $search = '<p>' . $this->CI->lang->line('mb75') . '</p>';
        }
        return $this->assets().' 
                <div class="col-lg-6">
                    <div class="panel">
                ...
                <div class="col-lg-6 visam-comments">
                    <div class="panel">
                        <div class="panel-heading">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#visam-options" data-toggle="tab" class="bolis">
                                        <i class="fa fa-sliders"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#visam-members" data-toggle="tab" class="bolis2">
                                        <i class="fa fa-users"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#visam-stats" data-toggle="tab" class="bolis3">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="visam-options">
                                <div class="setrow">
                                    <div class="col-lg-10 col-sm-9 col-xs-9">' . $this->CI->lang->line('mb76') . '</div>
                                    <div class="col-lg-2 col-sm-3 col-xs-3 text-right visam-account-select">
                                ...
                                <div class="setrow">
                                    ...
                                    <div class="col-lg-2 col-sm-3 col-xs-3 text-right visam-status">
                                        active
                                    </div>
                                </div>
                                <div class="setrow">
    ...
    public function assets() {
                        ...
                        if(http.readyState == 4 && http.status == 200) {
                            ...
                            if(data){
                                ...
                                for(var m = 0; m < data.length; m++) {
                                    tot += \'<li><div class="col-lg-1 col-sm-2 col-xs-2 clean"><img src="\' + data[m][3] + \'"></div><div class="col-lg-11 col-sm-10 col-xs-10 clean"><h3>\' + data[m][1] + \'</h3><h4>' . $this->CI->lang->line('mb68') . ': \' + data[m][2] + \'</h4></div></li>\';
                                }
                ...
                function follow() {
                    ...
                    http.onreadystatechange = function() {
                        if(http.readyState == 4 && http.status == 200) {
                            var data = http.responseText;
                            if(data == 1) {
                                popup_fon(\'subi\', \'' . $this->CI->lang->line('mb77') . '\', 1500, 2000);
                    ...
                    http.onreadystatechange = function() {
                        ...
                        if(data) {
                            ...
                            for(var m = 0; m < data.members.length; m++) {
                                tot += \'<li><div class="col-lg-10 col-sm-10 col-xs-9 clean"><h3>\' + data.members[m][1] + \'</h3><h4>\' + data.members[m][2] + \' members found</h4></div><div class="col-lg-2 col-sm-2 col-xs-3 clean text-right"><button type="button" data-id="\' + data.members[m][0] + \'" class="btn btn-labeled btn-primary manage-saved-search"><span class="btn-label">' . $this->CI->lang->line('mb67') . '</span></button></div></li>\';
                            }
                    ...
                    http.onreadystatechange = function() {
                        ...
                        if(data) {
                            ...
                            for(var m = 0; m < data.length; m++) {
                                ...
                                tot += \'<li data-id="\' + data[m].rule2 + \'"><div class="col-lg-1"><img src="\' + data[m].rule7 + \'"></div><div class="col-lg-11"><h3>\' + data[m].rule3 + si + \'</h3><h4>' . $this->CI->lang->line('mb68') . ': \' + data[m].rule4 + \'</h4></div></li>\';
                            }
        ...
        . '<style>'
                ...
                . '.user-results > li, .visam-members-results > li {
                    list-style: none;
                    height: auto;
                    min-height: 80px;
                    margin-top: 10px;
                ...
                . '.search-results > li {
                 ...
                 . '.user-results > li > div > h3, .visam-members-results > li > div > h3, .search-results > li > div > h3 {
                    margin: 0;
                    font-size: 16px;
                }'
                 . '.user-results > li > div > h4, .visam-members-results > li > div > h4, .search-results > li > div > h4 {
                    font-size: 14px;
                    color: #999;
                }'
                 . '.manage-saved-search {
                 ...
                 . '.emails .nav-tabs>li>a.bolis, .emails .nav-tabs>li.active>a.bolis {
                    color: #D75DEE !important;
                }'
                 . '.emails .nav-tabs>li>a.bolis2 {
                    color: #69DDB2 !important;
                }'
                 . '.emails .nav-tabs>li>a.bolis3 {
                    color: #F58D47 !important;
                }'             
                 . '.enablus > label::after {
                ...
                . '.bs-captcha form{
                 ...
                 . 'section>.emails .sub-captcha .input-group>.input-group-btn>.btn {
                    text-decoration: none;
                    color: #fff;
                 ...
                 . 'section>.emails .sub-captcha .input-group>.input-group-btn>.btn:hover{
                    position: relative;
                    cursor: pointer;
