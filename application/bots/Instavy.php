                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="instavy-options">
                                <div class="setrow">
                                    ...
                                    <div class="col-lg-2 col-sm-3 col-xs-3 text-right instavy-account-select">
                                ...
                                <div class="setrow">
                                    ...
                                    <div class="col-lg-2 col-sm-3 col-xs-3 text-right instavy-status">
                                        active
                                    </div>
                                </div>
                                <div class="setrow">
    ...
    public function assets() {
                ...
                function follow() {
                    ...
                    http.onreadystatechange = function() {
                        if(http.readyState == 4 && http.status == 200) {
                            ...
                            console.log(data);
                            if(data == 1) {
                                popup_fon(\'subi\', \'' . $this->CI->lang->line('mb51') . '\', 1500, 2000);
                    ...
                    http.onreadystatechange = function() {
                        ...
                        if(data) {
                            ...
                            for(var m = 0; m < data.members.length; m++) {
                                tot += \'<li><div class="col-lg-10 col-sm-10 col-xs-10 clean"><h3>\' + data.members[m][1] + \'</h3><h4>\' + data.members[m][2] + \' ' . $this->CI->lang->line('mb87') . '</h4></div><div class="col-lg-2 col-sm-2 col-xs-2 clean text-right"><button type="button" data-id="\' + data.members[m][0] + \'" class="btn btn-labeled btn-primary manage-saved-search"><span class="btn-label">' . $this->CI->lang->line('mb67') . '</span></button></div></li>\';
                            }
                    ...
                    http.onreadystatechange = function() {
                        ...
                        if(data) {
                            ...
                            for(var m = 0; m < data.length; m++) {
                                ...
                                tot += \'<li data-id="\' + data[m].rule2 + \'"><div class="col-lg-1 col-sm-2 col-xs-2"><img src="\' + data[m].rule7 + \'"></div><div class="col-lg-11 col-sm-10 col-xs-10"><h3>\' + data[m].rule3 + si + \'</h3><h4>' . $this->CI->lang->line('mb68') . ': \' + data[m].rule4 + \'</h4></div></li>\';
                            }
        ...
        . '<style>'
                ...
                . '#twilos_main .search .btn.search-users {
                    background: #aa8f69 !important;
                }'
                . '#twilos_main .search .btn.search-users:hover {
                    background: #9c825e !important;
                }'                
                ...
                . '.user-results > li, .instavy-members-results > li {
                    list-style: none;
                    height: auto;
                    min-height: 80px;
                    margin-top: 10px;
                ...
                . '.search-results > li {
                 ...
                 . '.user-results > li > div > h3, .instavy-members-results > li > div > h3, .search-results > li > div > h3 {
                    margin: 0;
                    font-size: 16px;
                }'
                 . '.user-results > li > div > h4, .instavy-members-results > li > div > h4, .search-results > li > div > h4 {
                    font-size: 14px;
                    color: #999;
                }'
                 . '.manage-saved-search {
