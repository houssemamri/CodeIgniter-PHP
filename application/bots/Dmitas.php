...
class Dmitas implements Boots {
    ...
    public function content() {
        ...
        return $this->assets().' 
                        ...
                        <div class="panel-heading">
                            <ul class="nav nav-tabs">
                                <li class="active leposts">
                                    <a href="#dmitas_main" data-toggle="tab">
                ...
                <div class="col-lg-6 dmitas-options">
                    <div class="panel">
                        <div class="panel-heading">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                ...
                                <li>
                                    <a href="#dmitas-members" data-toggle="tab" class="bolis2">
                                        <i class="fa fa-users"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#dmitas-stats" data-toggle="tab" class="bolis3">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="instavy-options">
                                <div class="setrow">
                                    <div class="col-lg-10 col-sm-9 col-xs-9">' . $this->CI->lang->line('mb80') . '</div>
                                ...
                                <div class="setrow">
                                    <div class="col-lg-6 col-sm-12 col-xs-12">' . $this->CI->lang->line('mb81') . '</div>
    ...
    public function assets() {
                    ...
                    http.onreadystatechange = function() {
                        if(http.readyState == 4 && http.status == 200) {
                            ...
                            if ( !data ) {
                                ...
                                popup_fon(\'subi\', \'' . $this->CI->lang->line('mb85') . '\', 1500, 2000);
                            }
                        }
                    }
                    http.send(params);
                    ...
                    http.onreadystatechange = function() {
                        ...
                        if(data) {
                            ...
                            for(var m = 0; m < data.accounts.length; m++) {
                                tot += \'<li><div class="col-lg-11 col-md-11 col-sm-10 col-xs-10"><h3>\' + data.accounts[m].user_name + \'</h3></div><div class="col-lg-1 col-md-1 col-sm-2 col-xs-2 text-center clean"><button class="btn manage-account" type="button" data-id="\' + data.accounts[m].network_id + \'"><i class="fa fa-sliders"></i></button></div></li>\';
                            }
                            document.querySelector(\'.user-results\').innerHTML = tot;
                            setTimeout(reload_it,500);
                        } else {
                            document.querySelector(\'.user-results\').innerHTML = \'<p class="no-comments">' . $this->CI->lang->line('mb50') . '<p>\';
                        }
                    }
                    http.send();
                }
                    ...
                    http.onreadystatechange = function() {
                        ...
                        if(data) {
                            ...
                            for(var m = 0; m < data.users.length; m++) {
                                ...
                                tot += \'<li><div class="col-lg-1"><img src="\' + data.users[m].rule7 + \'"></div><div class="col-lg-11"><h3>\' + data.users[m].rule3 + bibo + \'</h3><h4>' . $this->CI->lang->line('mb68') . ': \' + data.users[m].rule4 + \'</h4></div></li>\';
                            }
        ...
        . '<style>'
                ...
                . '.user-results > li, .dmitas-members-results > li {
                    list-style: none;
                    height: auto;
                    min-height: 50px;
                    margin-bottom: 15px;
                ...
                . '.search-results > li {
                 ...
                 . '.user-results > li > div > h3, .dmitas-members-results > li > div > h3, .search-results > li > div > h3 {
                    margin: 0;
                    font-size: 16px;
                }'
                 ...
                 . '.user-results > li > div > h4, .dmitas-members-results > li > div > h4, .search-results > li > div > h4 {
                    font-size: 14px;
                    color: #999;
                }'
                 . '.manage-saved-search {
                 ...
                 . '.emails .panel-body .tab-pane ul>li {
                    padding: 4px 0;
                }'
                 . '.emails .panel-body .tab-pane ul.pagination>li {
                    padding: 4px 0;
                    border: 0;
                    box-shadow: none;
                }'                
    ...
    public function load_cron($user_id) {
        ...
        if($check2 == 2) {
            ...
            if ( $botis ) {
                ...
                $friends = $check->people->getSelfFollowers();
                if ( @$friends->users ) {
                    $mi = 0;
