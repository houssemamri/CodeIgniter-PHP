    ...
    public function user_data( $type, $user_id, $page ) {
        ...
        switch ( $type ) {
            ...
            case '2':
                ...
                // Gets number of total Feeds RSS
                $total = $this->rss->count_feeds($user_id);
                
                // Gets Feeds RSS based on pagination 
                $get_feeds = $this->rss->get_rss_feeds($user_id, $current_page, $limit);
