...
$username=$this->user->get_username_by_email('Name' , strtolower($email));
$role=$this->user->check_role_by_email(strtolower($email));

$this->session->set_userdata('username', strtolower($email));
