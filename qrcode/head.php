...
if ($_FILES) {
    ...
    if ((($_FILES["file"]["type"] == "image/gif")
        ...
        if ($filesize >= $MAX_FILESIZE) {
            ...
            if (!file_exists('qrcode/'.$USER_UPLOADS.$filename)) {
                move_uploaded_file($_FILES["file"]["tmp_name"], 'qrcode/'.$USER_UPLOADS.$filename);
            }
...
if ($logo) {
    ...
    $upthumb = makeThumb('qrcode/'.$USER_UPLOADS.$logo, 'qrcode/'.$USER_UPLOADS."thumb_".pathinfo($logo, PATHINFO_FILENAME).'.png', true, $thumbsize, $thumbsize);
}