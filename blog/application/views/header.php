      ...
      <div class="container">
        ...
        <section class="navbar-mobile">
          ...
          <ul class="nav nav-navbar ml-auto">
            <li class="nav-item nav-mega"><a class="nav-link" href="<?php echo $url;?>/"><?php echo $home;?></a></li>
            <li class="nav-item nav-mega"><a class="nav-link" href="<?php echo $url;?>/scheduledemo.php">Demo</a></li>
            <li class="nav-item nav-mega"><a class="nav-link" href="<?php echo base_url();?>">Blog</a></li>
            <li class="nav-item nav-mega"><a class="nav-link" href="<?php echo $url;?>/contact.php"><?php echo $contact;?></a></li>
            <li class="nav-item">
        ...
        <a class="btn btn-xs btn-round btn-success" href="<?php echo $url;?>/auth/index"><?php echo $login;?></a>
