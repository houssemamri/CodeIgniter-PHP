                  ...
                  <div class="col-lg-12">
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="<?php echo base_url();?>admin/mini/Spanish/submitPost" method="post" class="form-horizontal">
                          <?php
                            if(isset($success))
                            {?>
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                              <input type="text" id="title" name="title" placeholder="Title" class="form-control" value="<?php echo $row->Title_Spa;?>" required>
                            </div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-3"><label for="textarea-input" class=" form-control-label">Content English *</label></div>
                            <div class="col-12 col-md-9"><textarea name="content" id="content" rows="12" placeholder="Content English" class="form-control" required><?php echo $row->Content_Spa;?></textarea></div>
                          </div>
