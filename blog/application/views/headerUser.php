...
<html lang="en">
  ...
  <body>
 <?php if(isset($_SESSION) && !empty($_SESSION['user_name'])){ ?>
    <!-- Navbar -->
      ...
      <div class="container">
        ...
        <section class="navbar-mobile">
          ...
          <ul class="nav nav-navbar ml-auto">
            <li class="nav-item"><a class="nav-link" href="https://review-thunder.com"><?php echo $home;?></a></li>
              <li class="nav-item"><a class="nav-link" href="<?php echo base_url();?>?id=<?php echo $_SESSION['user_id'];?>">Blog</a></li>
            <li class="nav-item"><a class="nav-link" href="https://review-thunder.com/article.php?status=true&type=Hotel&lang=fr&article=1"><?php echo $article;?></a></li>
            <li class="nav-item">
              <a class="nav-link" href="#">Database <span class="arrow"></span></a>
              <nav class="nav">
                <a class="nav-link" href="https://review-thunder.com/upload.php?status=true&type=Hotel&lang=fr&article=1"><?php echo $add;?></a>
                <a class="nav-link" href="https://review-thunder.com/update.php?status=true&type=Hotel&lang=fr&article=1"><?php echo $update;?></a>
              </nav>
            </li>
            <li class="nav-item"><a class="nav-link" href="https://review-thunder.com/support.php"><?php echo $support;?></a></li>
            <?php
                if(isset($_SESSION['admin_status'])){?>
                 <li class="nav-item"><a class="nav-link" href="https://review-thunder.com/adminProfile.php">Admin Panel</a></li>
              <?php
                }
             ?>
             <li class="nav-item">
               ...
               <nav class="nav">
                 <a class="nav-link" href="https://review-thunder.com/profile.php?id=<?php echo $_SESSION['user_id'];?>"><?php echo $account;?></a>
                 <a class="nav-link" href="https://review-thunder.com/masterAcc.php?id=<?php echo $_SESSION['user_id'];?>"><?php echo $manageAcc;?></a>
                 <a class="nav-link" href="https://review-thunder.com/profile.php?id=<?php echo $_SESSION['user_id'];?>&type=1"><?php echo $manageEmailList;?></a>
                 <a class="nav-link" href="https://review-thunder.com/profile.php?id=<?php echo $_SESSION['user_id'];?>&type=2"><?php echo $sendEmail;?></a>
                 <a class="nav-link" href="https://review-thunder.com/logout.php"><?php echo $logout;?></a>
               </nav>
             </li>
             <li class="nav-item">
