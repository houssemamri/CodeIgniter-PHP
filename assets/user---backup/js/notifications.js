            ...
            jQuery.ajax({
                ...
                success: function (data)
                {
                    ...
                    else
                    {
                        ...
                        if (n === 1)
                        {
                            jQuery(".list-group").html('<li class="list-group-item">'+translation.mm131+'</li>');
                        }
                    }
                },
    ...
    function get_notification(id)
    {
        ...
        jQuery.ajax({
            ...
            success: function (data)
            {
                ...
                {
                    content += '<h2>' + data[0].notification_title + '<a href="#" class="label label-danger delnot" data-id="' + id + '">'+translation.mm133+'</a></h2>';
                }
