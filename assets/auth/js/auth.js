...
//alert(url);
    jQuery('.signin').submit(function (e) {
        ...
        var data1 = {setLang:jQuery('#setLang_id').val(),email: jQuery('.username').val(), password: jQuery('.password').val(), remember: remember, csrf_test_name: name};
        ...
        jQuery.ajax({
            ...
            success: function (data)
            {
                ...
                jQuery.ajax({
            url: url + 'newsletter/admin/pg.login_external.php?login='+jQuery('.username').val(),
            type: 'GET',
            ...
            success: function (requestdata)
            {
                ...
                if(requestdata ==1){
                    ...
                    document.location.href = url + 'admin/home';
                }else{
