...
class Db{
	...
	public function get_template_blocks($tempId) {
	...
	}	public function schedule_email($gid,$choose_temp,$subject,$schedule_date,$schdeule_time,$creat_date,$creat_time){
		...
		try {
      $conn=$this->connect();
			$stmt = $conn->prepare("INSERT INTO `schedule_email`(`gid`, `temp_id`, `subject`, `schedule_date`, `schdeule_time`, `creat_date`, `creat_time`) VALUES (?,?,?,?,?,?,?)");
			//echo $stmt;die();
			$stmt->bind_param("sssssss", $gid,$choose_temp,$subject,$schedule_date,$schdeule_time,$creat_date,$creat_time);
	...
	public function insertEmailLog($userid,$gid,$template_id,$email_id,$subject,$email_body,$send_date,$send_time){
      ...
      $conn=$this->connect();
			...
			//echo $stmt;die();
			$stmt->bind_param("ssssssss", $userid,$gid,$template_id,$email_id,$subject,$email_body,$send_date,$send_time);
