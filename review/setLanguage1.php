...
if(strcmp($lang,'en')==0)
{
  ...
  /* Selection page */
  $welcome="Welcome";
  $welcomeMsg="Choose from any of the four options below or checkout the tutorial.";
  ...
  $contactInfo="Give us a call or stop by our door anytime, we try to answer all enquiries within 24 hours on business days. <br /><br /> We are open from 9am 6pm week days";
...
else if(strcmp($lang,'spa')==0)
{
  ...
  /* Selection page */
  $welcome="Bienvenido";
  $welcomeMsg="Eliges una de las actividades o puedes nuestro tutorial.";
  $msgUsr="No hay nada de mas importante que la personalización. Billiones de respuestas posibles están incluidas dentro de este Aplicación.";
  $sec1="Hotel";
  $sec2="Restaurante";
  $sec3="Recreativa";
  $sec4="Cultura";
  ...
  $updateMsg="Modificar las Partes de lors diferentes typos de Respuestas que puedes ver a bajo.";
  $select="Seleccionar";
  $updateBtn="Cargar";
  ...
  $profile="Perfil";
  $profileWelcome="Bienvenido sobre tu Perfil";
...
else
{
  ...
  $msgUsr="Rien n’est plus important que la personnalisation. Des milliards de réponses possibles sont inclues sein de ce logiciel";
  $sec1="Hôtel";
  $sec2="Restaurant";
  $sec3="Loisirs";
  $sec4="Culture";
  ...
  $sex2="Femme";
  $sex3="Unisexe";
  $positive=array("Salutation","Merci du Choix","Bien passé?","Merci pour l’avis","Partie Préféré","Importance des Avis","Suivi Internet ou Autre Cloture","Formule de politesse");
  $negative=array("Salutation","Merci du Choix","Que s'est il passé?","Situation 1","Situation 2","Partie Préféré","Situation 3","Situation 4","Explication","Cloture","Formule de politesse");
  $simple=array("Salutation","Merci d'être venu","Merci pour l’avis","Partie Préféré","Cloture","Formule de politesse");
  ...
  /*Upload Section*/
  $uploadWelcome="Choisir une des Options pour ajouter vos parties à chacune des possibilités de réponses.";
  $uploadTitle="Charger";
  ...
  $updateWelcome="Choisir une des Options pour modifier vos parties et cela pour chacune des possibilités de réponses.";
  ...
  $manageEmailList="Gérer Listes d’Email";
  $manageEmail="Gestion Email";
  $atLeastOne="Por favor selectionas a lo menos un Email";
  $subject="Tema";
