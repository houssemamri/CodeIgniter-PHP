...
class Twilos implements Boots {
    ...
    public function content() {
        ...
        if(($this->tw_key == '') || ($this->tw_secret == '')) {
            $search = '<p>' . $this->CI->lang->line('mb46') . '</p>';
        }
        return $this->assets().' 
                <div class="col-lg-6">
                    <div class="panel">
                ...
                <div class="col-lg-6 twilos-comments">
                    <div class="panel">
                        <div class="panel-heading">
                            <ul class="nav nav-tabs">
                                <li class="active">
                                    <a href="#twilos-options" data-toggle="tab" class="bolis">
                                        <i class="fa fa-sliders"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#twilos-members" data-toggle="tab" class="bolis2">
                                        <i class="fa fa-users"></i>
                                    </a>
                                </li>
                                <li>
                                    <a href="#twilos-stats" data-toggle="tab" class="bolis3">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="twilos-options">
                                <div class="setrow">
                                    <div class="col-lg-10 col-sm-9 col-xs-9">' . $this->CI->lang->line('mb28') . '</div>
                                    <div class="col-lg-2 col-sm-3 col-xs-3 text-center twilos-account-select">
                                ...
                                <div class="setrow">
                                    ...
                                    <div class="col-lg-2 col-sm-3 col-xs-3 text-center twilos-status">
                                        active
                                    </div>
                                </div>
                                <div class="setrow">
    ...
    public function assets() {
                        ...
                        if(http.readyState == 4 && http.status == 200) {
                            ...
                            if(data){
                                ...
                                for(var m = 0; m < data.length; m++) {
                                    tot += \'<li><div class="col-lg-1 col-sm-2 col-xs-2 clean"><img src="\' + data[m][3] + \'"></div><div class="col-lg-11 col-sm-10 col-xs-10 clean"><h3>\' + data[m][1] + \'</h3><h4>' . $this->CI->lang->line('mb40') . ': \' + data[m][2] + \'</h4></div></li>\';
                                }
                ...
                function follow() {
                    ...
                    http.onreadystatechange = function() {
                        if(http.readyState == 4 && http.status == 200) {
                            ...
                            console.log(data);
                            if(data == 1) {
                                popup_fon(\'subi\', \'' . $this->CI->lang->line('mb41') . '\', 1500, 2000);
                    ...
                    http.onreadystatechange = function() {
                        ...
                        if(data) {
                            ...
                            for(var m = 0; m < data.members.length; m++) {
                                tot += \'<li><div class="col-lg-10 col-md-10 col-sm-9 col-xs-9 clean"><h3>\' + data.members[m][1] + \'</h3><h4>\' + data.members[m][2] + \' ' . $this->CI->lang->line('mb69') . '</h4></div><div class="col-lg-2 col-md-2 col-sm-3 col-xs-3 clean text-right"><button type="button" data-id="\' + data.members[m][0] + \'" class="btn btn-labeled btn-primary manage-saved-search"><span class="btn-label">' . $this->CI->lang->line('mb67') . '</span></button></div></li>\';
                            }
                    ...
                    http.onreadystatechange = function() {
                        ...
                        if(data) {
                            ...
                            for(var m = 0; m < data.length; m++) {
                                ...
                                tot += \'<li data-id="\' + data[m].rule2 + \'"><div class="col-lg-1 col-sm-2 col-xs-2"><img src="https://twitter.com/\' + data[m].rule3 + \'/profile_image?size=normal"></div><div class="col-lg-11 col-sm-10 col-xs-10"><h3>\' + data[m].rule3 + si + \'</h3><h4>' . $this->CI->lang->line('mb40') . ': \' + data[m].rule4 + \'</h4></div></li>\';
                            }
        ...
        . '<style>'
                ...
                . '.user-results > li, .twilos-members-results > li {
                    list-style: none;
                    height: auto;
                    min-height: 80px;
                    margin-top: 10px;
                ...
                . '.search-results > li {
                 ...
                 . '.user-results > li > div > h3, .twilos-members-results > li > div > h3, .search-results > li > div > h3 {
                    margin: 0;
                    font-size: 16px;
                }'
                 . '.user-results > li > div > h4, .twilos-members-results > li > div > h4, .search-results > li > div > h4 {
                    font-size: 14px;
                    color: #999;
                }'
                 . '.manage-saved-search {
                 ...
                 . '.manage-saved-search:hover, .manage-saved-search:focus, .manage-saved-search:active {
                    background-color: #24af97 !important;
                    border-color: #24af97 !important;
                }'
                ...
                if($key) {
                    ...
                    if($response) {
                        ...
                        foreach ($response as $res) {
                            $tot[] = [$res->id, $res->screen_name, $res->location, 'https://twitter.com/' . $res->screen_name . '/profile_image?size=normal'];
                        }
            ...
            case '2':
                ...
                if($key) {
                    ...
                    if($new_bot) {
                        ...
                        if($response) {
                            foreach ($response as $res) {
                                $this->CI->ecl('Instance')->mod('botis', 'save_bot', ['twilos-follow', $this->CI->ecl('Instance')->user(),$new_bot,$res->id, $res->screen_name, $res->location, 'https://twitter.com/' . $res->screen_name . '/profile_image?size=normal', 1]);
                                $count++;
                            }
                            if($count > 0) {
                                echo 1;
            ...
            case '4':
                ...
                if($get_all_bots) {
                    ...
                    foreach($get_all_bots as $bot) {
                        ...
                        $members[] = ['rule2' => $bot->rule2, 'rule3' => $bot->rule3, 'rule4' => $bot->rule4, 'fol' => $fol];
                    }
