                    ...
                    <div class="widget-box">
                        <div class="widget-header">
                            <div class="widget-toolbar">
                                <ul class="nav">
                                    <li class="nav-item"> <a data-toggle="tab" href="#general" class="nav-link " aria-expanded="true"><?= $this->lang->line('mu73'); ?></a> </li>
                                    <li class="nav-item"> <a data-toggle="tab" href="#advanced" class="nav-link " aria-expanded="false"><?= $this->lang->line('mu74'); ?></a> </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="tab-content">
                                    <div id="general" class="tab-pane active">
                                        <div class="setrow">
                                            ...
                                            <div class="col-lg-2 col-sm-3 col-xs-3 text-right">
                                                <div class="enablus pull-right">
                                                    <input id="email_notifications" name="email_notifications" checked <?php //if (isset($options["email_notifications"])) echo 'checked="checked"'; ?> class="setopt" type="checkbox">
                                        ...
                                        <div class="setrow">
                                            ...
                                            <div class="col-lg-2 col-sm-3 col-xs-3 text-right">
                                                <div class="enablus pull-right">
                                                    <input id="error_notifications" name="error_notifications" checked <?php //if (isset($options["error_notifications"])) echo 'checked="checked"'; ?> class="setopt" type="checkbox">
                                        ...
                                        <div class="setrow">
                                            ...
                                            <div class="col-lg-2 col-sm-3 col-xs-3 text-right">
                                                <div class="enablus pull-right">
                                                    <input id="disable_preview" name="disable_preview" checked <?php //if (isset($options["disable_preview"])) echo 'checked="checked"'; ?> class="setopt" type="checkbox">
                                        ...
                                        <div class="setrow">
                                            ...
                                            <div class="col-lg-2 col-sm-3 col-xs-3 text-right">
                                                <div class="enablus pull-right">
                                                    <input id="notification_tickets" name="notification_tickets" checked <?php //if (isset($options["notification_tickets"])) echo 'checked="checked"'; ?> class="setopt" type="checkbox">
