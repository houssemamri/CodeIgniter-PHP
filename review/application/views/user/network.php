                        ...
                        <li>
                            ...
                            if (isset($limit)) {
                                if (file_exists(APPPATH . 'autopost/' . $network . '.php')) {
                                    ...
                                    $info = $get->get_info();
                                    ?>
                                    <div class="col-md-1 clean text-right">
                                        <a href="<?= base_url(); ?>user/connect/<?= strtolower($network); ?>"<?= $popup; ?> class="btn btn-default"><span class="new-account-btn"><span style="color: <?= $info->color; ?>; margin-right:3px"><?= str_replace(' style="color:#ffffff"','',$info->icon); ?></span> <?= $this->lang->line('mu89'); ?></span><span class="new-account-btn-li"><i class="fa fa-plus" aria-hidden="true"></i> <?= $this->lang->line('mu90'); ?></span></a>
