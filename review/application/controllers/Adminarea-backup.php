...
class Adminarea extends MY_Controller {
    ...
    public function networks() {
        ...
        foreach (glob(APPPATH . 'autopost/*.php') as $filename) {
			...
			$redirect_link="get_content_menu('".strtolower($className)."')";
            $classes [] = '<li>
                                ...
                                <div class="col-md-2 col-sm-4 col-xs-6 clean text-right">
                                    <a onclick="'.$redirect_link.'" href="javascript:void("0");"><button type="button" class="btn btn-default"><i class="fa fa-cogs" aria-hidden="true"></i> ' . $this->lang->line('ma134') . '</button></a> 
                                </div>
                            </li>';
        }
