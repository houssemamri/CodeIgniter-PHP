...
class Bots extends MY_Controller {
    ...
    public function manage_bots() {
        ...
        foreach ( glob(APPPATH . 'bots/*.php') as $filename ) {
            ...
            $classes [] = '
                <li>
                    <button class="btn-tool-icon btn btn-default bots-button btn-xs pull-left" type="button"><i class="fa fa-thumb-tack"></i></button>
    ...
    public function bots($name = NULL) {
        ...
        if ( $this->options->check_enabled('enable_bots_page') == false ) {
            ...
            if ( $name ) {
                ...
                $this->content = ['bots' => $classes, 'favourites' => $favourites, 'options' => $options];
