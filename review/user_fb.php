...
$loginUrl = $helper->getLoginUrl('https://review-thunder.com/review/fb_/fb-callback.php', $permissions);
...
<div class="row">
 <h6 style="font-weight:bold;">Retrieving An Id Token:</h6>
  ...
  <?php
if (isset($loginUrl)) { 
	echo "<a class='btn btn-lg btn-primary' style='display:table;margin:0 auto;'  href='" . $loginUrl . "'>Connect Me!</a>";
