<div class="row">
  <h6 class="center-text" style="font-weight:bold;font-size:32px;"><?php echo $manageEmail;?></h6>
  <div class="col-lg-12">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <label for="company"><?php echo $registerCompany;?>: </label> <input type="text" name="company" id="companyName" value=""/><br /><br />
    ...
    <div class="table-responsive">
                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      else
                      {
                        while($row=$result->fetch_assoc())
                        {
                        	$sql_Last_email = "SELECT * FROM emaillog WHERE email_id = '".$row['Email']."' ORDER BY ID DESC";
                        	
                        	$result_last_email=$conn->query($sql_Last_email);
                        	$row_last_email = $result_last_email->fetch_assoc();
                        	
                        	$sql_last_sms = "SELECT * FROM sms_log WHERE receive_number = '".$row['Mobile']."' ORDER BY ID DESC";
                        	$result_last_sms=$conn->query($sql_last_sms);
                        	$row_last_sms = $result_last_sms->fetch_assoc();
                        	
                        ?>
                          <tr>
                            <td><input type="checkbox" class="emaillist contactlistCheckbox" value="<?php echo $row['EID'];?>" /></td>
                            <td style="width: 20px !important;" class="text-left"><?php echo $row['Email'];?></td>
                            <td class="text-left"><?php echo $row['First'] . ' ' . $row['Last'];?></td>
                            <td class="text-left"><?php echo $row['Company'];?></td>
                            <td class="text-left"><?php echo $row['Mobile'];?></td>
                            <td class="text-left"><?php echo $row_last_email['send_date'];?></td>
                            <td class="text-left"><?php echo $row_last_sms['send_date'];?></td>
                 ...
                 <div class="modal-dialog" role="document">
                   <div class="modal-content">
                     ...
                     <div class="modal-body">
                       ...
                       <label for="last">Last Name: </label> <input type="text" name="lastName" id="lastName<?php echo $row['EID'];?>" value="<?php echo $row['Last'];?>"/><br /><br />
                       <label for="company"><?php echo $registerCompany;?>: </label> <input type="text" name="company" id="company<?php echo $row['EID'];?>" value="<?php echo $row['Company'];?>"/><br /><br />
                       <label for="mobile">Mobile: </label> <input type="text" name="mobile" id="mobile<?php echo $row['EID'];?>" value="<?php echo $row['Mobile'];?>"/>
                       <br /><br />
                       <label for="service">Product/Service Purchased: </label> <input type="text" name="service" id="service<?php echo $row['EID'];?>" value="<?php echo $row['service'];?>"/>
                       <br /><br />
                       <label for="comment">Comment: </label> <input type="text" name="comment" id="comment<?php echo $row['EID'];?>" value="<?php echo $row['comment'];?>"/>
                       <br /><br />
          ...
          <br /><br /><br /><br />
          <h6 style="font-weight:bold"><?php echo $uploadMultiEmail;?></h6>
