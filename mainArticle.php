        ...
        <div class="container">
          ...
          <div class="text-center">
            <ul class="nav nav-outline nav-round">
              ...
              <li class="nav-item w-140">
                  <a class="nav-link nav-user <?php echo $active[1];?>" href="?status=true&type=Restaurant&lang=fr&article=1" style="padding: 5px 0"><?php echo $sec2;?></a>
              </li>
              <li class="nav-item w-140">
