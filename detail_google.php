...
curl_setopt_array($curl, array(
    CURLOPT_URL => "https://mybusiness.googleapis.com/v4/categories?regionCode=US&languageCode=fr&searchTerm=".$cat,
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
...
curl_setopt_array($curl, array(
    CURLOPT_URL => "https://mybusiness.googleapis.com/v4/" . $name . "/reviews",
    CURLOPT_RETURNTRANSFER => true,
    CURLOPT_ENCODING => "",
    CURLOPT_MAXREDIRS => 10,
    CURLOPT_TIMEOUT => 30,
    ...
    <div class="">
        <div class="inner-review1">
            <div class="full-row">
                ...
                <ul>
                    <li><a href="javascript:void(0)" id="toggle_menu1"><img src="/img/icon.png"></a></li>
                    <li><img src="/img/logo_google.png"></li>
                    <li><?php echo @$mu_business; ?></li>
            </div>
            <div class="inner-tabview">
                <div id="Left_menu_div1" class="left-bar slide-left">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item google_link_mobile">
                        ...
                        <li class="nav-item google_link_mobile">
                            <a class="nav-link " id="home-tab" data-toggle="tab"   href="#google_Posts" role="tab" aria-controls="home" aria-selected="false"><i class="fa fa-clipboard" aria-hidden="true"></i><?php echo @$Post; ?></a>
                        </li>
                        <li class="nav-item google_link_mobile">
                ...
                <div  id="right_menu_div1" class="right-bar post-main-tab">
          ...
          <!--google post -->              
                       <div class="tab-pane fade rect" id="google_Posts" role="tabpanel" aria-labelledby="google_Posts_tab">
	   ...
	   <div class="post-popup-area">
		  ...
		  <div class="whsts-pop-cont">
                          ...
                          <input type="submit" value="Publish" name="submit_form"  >
								...
								<?php include('gbm/edit/list_localpost.php');  ?>
								</div>
...
<script>
  ...
  $("#toggle_menu1").click(function () {
	...
	//alert(screen.width);
	if (screen.width < 768) {
	  $(".google_link_mobile").click(function () {
...
$(function() {
  ...
  $('.preview-section').on('click', '.remove_img_preview', function() {
    ...
    $(this).parent('.preview-section').empty();
  });
});
$(function () {
