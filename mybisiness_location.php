...
$sql="SELECT * FROM `networks` where user_id=".$_SESSION['user_id']." and network_name='google_mybusiness'" ;
...
curl_setopt_array($curl, array(
  CURLOPT_URL => "https://mybusiness.googleapis.com/v4/accounts/".$data['net_id']."/locations",
...
<section class="google-demo">
    <div class="">
      <div class="inner-review">
        <div class="full-row">
          <ul>
          <!--li><a href="javascript:void(0)" id="toggle_menu"><img src="/img/icon.png"></a></li-->
          <li><img src="/img/logo_google.png"></li>
          <li><?php echo @$mu_business;  ?></li>
        </div>
        <div class="inner-tabview">
          <!--div id="Left_menu_div" class="left-bar slide-left">
        ...
        <div  id="right_menu_div" class="right-bar">
	...
	?>
                 ...
                 <div class="location-loop">
                  <ul>
                    ...
                    <li class="name-list">
                      <a  onclick="" href="javascript:void(0)"><h6><?php echo $res1->locationName;   ?></h6>
					 ...
					 <?php if(@$res1->locationState->isPublished=="1"){?>
					 <li> <button type="button" class="btn btn-success localpost" data-name="<?php echo $res1->name; ?>"> <?= $this->lang->line('mu43'); ?></button></li>
					 <?php } ?>
                  </ul>
                </div>
<?php } ?>
