...
$conn->close();
  ...
  $redirect = base_url2().'profile.php?id='.$user_id;
...
<div class="row full-row">
 <h6 class="center-text" style="font-weight:bold;"><?php echo $retrievingIdToken;?>:</h6>
      
  <br /><br />
  <?php
if (isset($authUrl)) { 
	echo "<a class='btn btn-lg btn-primary' style='display:table;margin:0 auto;'  href='" . $authUrl . "'>".$connectme."!</a>";
