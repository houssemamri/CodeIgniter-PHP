...
<html lang="en">
  <head>
    ...
    <style>
      ...
      input[type="file" i],input[type="file" i]:focus,.custom-file input:hover, .custom-file input:focus {
  ...
  <body>
    ...
    if(strcmp($lang,'en')==0)
    {
      ...
      $uploadHeader2 = "Select the Document within your Computer";
      $question = "A Question?";
      $avatarText = strtoupper("Good customised Texts for great Answers!");
    }
    else if(strcmp($lang,'spa')==0)
    {
      $uploadMain = "Para agregar texto al programa";
      $uploadHeader1 = "Seleccione las categorías";
      $uploadHeader2 = "Seleccione el documento en su ordenador Cargue el documento";
      $question = "Algunas Preguntas ?";
      $avatarText = strtoupper("Buenos textos personalizados para buenas respuestas.");
    ...
    else
    {
      ...
      $uploadHeader2 = "Selectionnez le Document sur votre Ordinateur Chargez le Document";
      $question = "Une Question ?";
      $avatarText =strtoupper("De bons textes personnalisés pour de bonnes réponses!");
